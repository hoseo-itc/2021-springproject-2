...
@Repository
public class H2AddressRepository implements MenuRepository {
	...
	public List<Menu> findByShopNo(int shopNo) {
		return template.query("select * from menu where shop_no = ?",
				new BeanPropertyRowMapper<Menu>(Menu.class), shopNo);
	}
